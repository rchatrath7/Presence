...
public class SpatialUnderstandingCursor : SpatialUnderstandingBasicCursor
{
    ...
    public bool RayCastUI(out Vector3 hitPos, out Vector3 hitNormal, out UnityEngine.UI.Button hitButton)
    {
        // Defaults
        hitPos = Vector3.zero;
        ...
        if (Physics.Raycast(uiRayCastOrigin, uiRayCastDirection, out hitInfo, RayCastLength, UILayerMask))
        {
            ...
            if (canvas != null)
            {
                ...
                if (canvasRaycaster != null)
                {
                    ...
                    {
                        UnityEngine.UI.Button button = canvasHits[i].gameObject.GetComponent<UnityEngine.UI.Button>();
                        if (button != null)
                        {
